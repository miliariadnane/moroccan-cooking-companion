                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="h-full space-y-4">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            Tagine: A slow-cooked stew with meat, vegetables, and aromatic spices. Served with couscous.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            Couscous: Steamed semolina grains, often served with a stew or topped with vegetables and meat.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            Harira: A hearty lentil and lamb soup, flavored with cinnamon, ginger, and other spices.
                        </p>
                    </div>
                </div>
            </div>
